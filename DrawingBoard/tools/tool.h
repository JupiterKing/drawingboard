...
{
public:
	enum Type {FREEHAND = 0, ERASER, LINE,DOTLINE,ARROW, RECTANGLE, ELLIPSE, BEZIER, FLOODFILL, ANNOTATION, PICKER, LASERPOINTER, SELECTION, POLYGONSELECTION, MOUSETOOL, _LASTTOOL};
	 ...
	 * @param constrain is the "constrain motion" button pressed //modifiers.testFlag(Qt::ShiftModifier) 
	 * @param cener is the "center on start point" button pressed,,//modifiers.testFlag(Qt::AltModifier)
	 */
