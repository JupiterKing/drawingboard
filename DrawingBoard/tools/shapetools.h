...
protected:
	...
	QRectF ArrowRect() const { return QRectF(m_p1, m_p2); }
...
/* ÐéÏß                                                                  */
/************************************************************************/
class DotLine :public ShapeTool
{
public:
	DotLine(ToolController &owner);
...
/* ¼ýÍ·                                                                     */
/************************************************************************/
class Arrow :public ShapeTool
{
public:
	Arrow(ToolController &owner);
