...
QT_MOC_LITERAL(3, 21, 14), // "columnsChanged"
QT_MOC_LITERAL(4, 36, 13) // "colorsChanged"

    },
    "Palette\0nameChanged\0\0columnsChanged\0"
    "colorsChanged"
};
...
void Palette::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Palette::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Palette::nameChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Palette::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Palette::columnsChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Palette::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Palette::colorsChanged)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject Palette::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Palette.data,
...
// SIGNAL 0
void Palette::nameChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void Palette::columnsChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 1, Q_NULLPTR);
}

// SIGNAL 2
void Palette::colorsChanged()
{
