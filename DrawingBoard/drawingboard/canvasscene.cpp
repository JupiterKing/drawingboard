...
#include "drawingboard/annotationitem.h"
#include "drawingboard/lasertrailitem.h"
...
//    m_cefview = new CefViewItem();
//    m_cefview->loadUrl("http://www.youku.com");
//    addItem(m_cefview);
...
void CanvasScene::onSelectionChanged(canvas::canvasSelection *selection)
{
	if(m_selection) {
